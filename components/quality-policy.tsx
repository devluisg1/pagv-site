        ...
        <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
          {policies.map((policy, index) => {
            ...
            return (
              <div
                key={index}
                className={`group bg-[#3f5871] rounded-2xl p-6 sm:p-8 hover:bg-[#4a6480] transition-all duration-500 border border-white/20 hover:border-[#d4af37]/50 hover:shadow-2xl hover:-translate-y-2${isLastOdd ? " sm:col-span-2 sm:max-w-lg sm:mx-auto sm:w-full" : ""}`}
              >
